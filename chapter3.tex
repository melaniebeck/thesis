...
%\mathcal{M} & = & \left[
%	\begin{array}{cc}
%		P(``\text{Featured}"|\text{Not}, \mathbf{d}) ~~& P(``\text{Featured}" | \text{Featured}, \mathbf{d}) \\[0.3em]
%		P(``\text{Not}"|\text{Not}, \mathbf{d})~~& P(``\text{Not}"| \text{Featured}, \mathbf{d}) \\[0.3em]
%	\end{array}\right]
%\end{eqnarray}
