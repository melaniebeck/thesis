...
\begin{figure}
\includegraphics[width=\textwidth]{Figures/expert_vs_volunteer_votes_highskill_11-6-17.png}
...
We discover indications of volunteer bias towards labeling galaxies as `Smooth' or `Not Featured'. For each galaxy in our gold standard sample we select the five most skilled volunteers who classified that galaxy, where skill is determined by the volunteer confusion matrix in Figure \ref{fig: confusionmatrix}. Thi
